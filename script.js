...
const instruments = [
    { name: "01", type: "ZAM", sound: "Sound/Ejemplos/01.mp3" },
    { name: "02", type: "CHS", sound: "Sound/Ejemplos/02.mp3" },
    { name: "03", type: "CHS", sound: "Sound/Ejemplos/03.mp3" },
    { name: "04", type: "GAT", sound: "Sound/Ejemplos/04.mp3" },
    { name: "05", type: "CHS", sound: "Sound/Ejemplos/05.mp3" },
    { name: "06", type: "CHD", sound: "Sound/Ejemplos/06.mp3" },
    { name: "07", type: "CHD", sound: "Sound/Ejemplos/07.mp3" },
    { name: "08", type: "CHD", sound: "Sound/Ejemplos/08.mp3" },
    { name: "09", type: "CHS", sound: "Sound/Ejemplos/09.mp3" },
    { name: "10", type: "CHS", sound: "Sound/Ejemplos/10.mp3" },
    { name: "11", type: "CUE", sound: "Sound/Ejemplos/11.mp3" },
    { name: "12", type: "CUE", sound: "Sound/Ejemplos/12.mp3" },
    { name: "13", type: "GAT", sound: "Sound/Ejemplos/13.mp3" },
    { name: "14", type: "GAT", sound: "Sound/Ejemplos/14.mp3" },
    { name: "15", type: "ZAM", sound: "Sound/Ejemplos/15.mp3" },
    { name: "16", type: "ZAM", sound: "Sound/Ejemplos/16.mp3" },
    { name: "17", type: "ZAM", sound: "Sound/Ejemplos/17.mp3" },
    { name: "18", type: "ESC", sound: "Sound/Ejemplos/18.mp3" },
    { name: "19", type: "ESC", sound: "Sound/Ejemplos/19.mp3" },
    { name: "20", type: "ESC", sound: "Sound/Ejemplos/20.mp3" },
    { name: "21", type: "ESC", sound: "Sound/Ejemplos/21.mp3" },
    { name: "22", type: "ZAM", sound: "Sound/Ejemplos/22.mp3" },
    { name: "23", type: "CHD", sound: "Sound/Ejemplos/23.mp3" },
    { name: "24", type: "CHD", sound: "Sound/Ejemplos/24.mp3" },
    { name: "25", type: "CUE", sound: "Sound/Ejemplos/25.mp3" },
    { name: "26", type: "GAT", sound: "Sound/Ejemplos/26.mp3" },
    { name: "27", type: "CUE", sound: "Sound/Ejemplos/27.mp3" },
    { name: "28", type: "CHS", sound: "Sound/Ejemplos/28.mp3" },
    { name: "29", type: "ZAM", sound: "Sound/Ejemplos/29.mp3" },
    { name: "30", type: "GAT", sound: "Sound/Ejemplos/30.mp3" }
...
document.getElementById("CHD-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("CHD");
});

document.getElementById("CHS-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("CHS");
});

document.getElementById("GAT-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("GAT");
});
...
document.getElementById("CUE-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("CUE");
});

document.getElementById("ZAM-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("ZAM");
});
